...
function CatalogFallback() {
  return (
    <div className="mt-12 h-48 animate-pulse border border-white/[0.08] bg-[#0a0a0a]" />
  );
}
      ...
      <section className="px-6 pb-20 pt-28 sm:px-10 sm:pb-24 sm:pt-32 lg:px-14 lg:pb-28">
        <div className="mx-auto max-w-[1440px]">
          <header className="mx-auto max-w-3xl text-center">
            <h1 className="text-[2rem] font-light uppercase tracking-[0.34em] text-white/95 sm:text-[2.35rem] lg:text-[2.6rem]">
              COLLECTION
            </h1>
            <span className="mx-auto mt-5 block h-px w-12 bg-gold/70" />
            <p className="mt-6 text-[13px] font-light leading-relaxed tracking-[0.04em] text-white/50 sm:text-sm">
