      ...
      <article className="px-6 pb-20 pt-28 sm:px-10 sm:pb-24 sm:pt-32 lg:px-14">
        <div className="mx-auto max-w-[1440px]">
          ...
          <header className="mt-10 max-w-3xl">
            ...
            <h1 className="mt-4 text-[1.85rem] font-light uppercase tracking-[0.22em] text-white sm:text-[2.4rem] lg:text-[2.75rem]">
              {project.title}
            </h1>
          ...
          <div className="mt-12 grid grid-cols-1 gap-10 border-y border-white/10 py-12 sm:mt-14 lg:grid-cols-[1fr_20rem] lg:gap-16">
            <div>
              ...
              <dl className="mt-10 grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-3">
                {specs.map((spec) => (
                  <div key={spec.label}>
                    <dt className="text-[9px] font-medium tracking-[0.24em] text-white/40">
                      {spec.label}
                    </dt>
                    <dd className="mt-2 text-[13px] font-light text-white/85 sm:text-sm">
                      {spec.value}
                    </dd>
                  </div>
                ))}
            ...
            <div>
              ...
              <ul className="mt-8 flex flex-col gap-3">
                {project.materialsUsed.map((material) => (
                  <li
                    key={material}
                    className="border-l border-gold/40 pl-4 text-[12px] font-light tracking-wide text-white/65 sm:text-[13px]"
                  >
                    {material}
                  </li>
                ))}
          ...
          <div className="mt-16 border border-white/[0.08] bg-[#0a0a0a] px-8 py-12 sm:px-12 sm:py-14">
            ...
            <div className="mt-8 flex flex-col items-start gap-4 sm:flex-row sm:gap-5">
              <Link
                href="/#contact"
                className="inline-flex h-14 w-full items-center justify-center border border-gold bg-transparent px-8 text-[12px] font-medium uppercase tracking-[0.08em] text-white transition-colors duration-300 hover:border-white hover:bg-white hover:text-[#050505] sm:w-auto"
              >
                Get In Touch
              </Link>
              <Link
