...
export const COLLECTION_ITEMS = CATALOG_PRODUCTS.map(({ id, label, image, alt }) => ({
  id,
  label,
  image,
  alt,
...
export const EDITORIAL_COLLECTIONS: EditorialCollection[] = [
  ...
  {
    id: "luxury-bathroom",
    eyebrow: "PURE MATERIALITY",
    title: "LUXURY BATHROOM",
    description:
      "Refined tile surfaces that create calm, clean and sophisticated bathroom interiors.",
    image: "/images/projects/modern-sanitary-space.jpg",
    alt: "Luxury bathroom with visible wall and floor tile surfaces",
    href: "/collection?material=Porcelain+Tile",
    imagePosition: "object-center",
  },
  {
    id: "modern-kitchen-wall",
