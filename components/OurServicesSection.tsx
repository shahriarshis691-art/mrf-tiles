    ...
    <section className="relative w-full bg-[#F9F9FB] overflow-hidden">
      <div className="mx-auto flex max-w-[1440px] w-full items-center justify-between overflow-hidden px-3 sm:px-10 lg:px-14">
        <div className="flex w-full items-center justify-between gap-2 sm:gap-6 md:gap-8">
          {/* Left Card (Text) */}
          <ScrollReveal variant="slideInLeft" className="flex flex-col min-w-0 w-[48%] sm:w-1/2">
              ...
              <div className="flex h-full flex-col justify-center">
                ...
                <div className="mb-2 overflow-hidden sm:mb-8">
                  <div className="flex whitespace-nowrap animate-marquee">
                    <span className="text-[2vw] sm:text-xs md:text-sm font-semibold tracking-[0.1em] sm:tracking-[0.2em] text-neutral-500 uppercase mx-0.5 sm:mx-4">
                      Porcelain Slabs
                    </span>
                ...
                {/* Header Title */}
                <h2 className="font-serif text-[clamp(1.1rem,4vw,4rem)] font-bold text-[#0F0F0F] leading-tight">
                  Our Services
                </h2>
                
                {/* Description Body */}
                <p className="mt-1 sm:mt-8 text-[clamp(0.65rem,2.2vw,1.125rem)] text-neutral-600 leading-relaxed">
          ...
          {/* Right Card (Image) */}
          <ScrollReveal variant="slideInRight" delay={0.15} className="flex items-stretch min-w-0 w-[52%] sm:w-1/2">
