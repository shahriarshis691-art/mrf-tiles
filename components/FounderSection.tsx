  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        <div className="flex flex-col gap-10 md:flex-row md:items-stretch md:gap-8 lg:gap-16 xl:gap-24">
          {/* Left: Typography */}
          <ScrollReveal variant="slideInLeft" className="w-full md:w-1/2">
            <div className="flex h-full w-full flex-col p-0 md:p-4 lg:max-w-lg lg:p-0">
              ...
              <h2
                id="founder-heading"
                className="mt-3 font-sans text-[clamp(1.5rem,5vw,2rem)] font-semibold uppercase leading-[1.05] tracking-[0.04em] text-neutral-900 md:mt-5 md:text-[2rem] md:tracking-[0.06em] lg:text-[2.5rem] xl:text-[2.85rem]"
              >
              ...
              <blockquote className="mt-6 text-[0.95rem] leading-[1.55] text-neutral-600 md:mt-8 md:text-base md:leading-relaxed lg:text-lg">
              ...
              <p className="mt-8 text-[10px] font-medium uppercase tracking-[0.12em] text-neutral-900 md:mt-8 md:pt-0 md:text-[11px] md:tracking-[0.2em]">
          ...
          <ScrollReveal variant="slideInRight" delay={0.15} className="w-full md:w-1/2">
            <div className="relative h-full w-full overflow-hidden border border-neutral-200/60 bg-neutral-100 transition-transform duration-500 ease-out hover:scale-[1.02]">
              <div className="relative aspect-[4/3] h-auto max-h-[380px] min-h-0 w-full bg-neutral-100 md:aspect-[3/4] md:h-[36rem] md:max-h-none">
                <Image
