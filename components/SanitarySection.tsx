    ...
    >
      <div className="mx-auto max-w-[1440px]">
        <header className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-[13px] font-light leading-relaxed text-white/50 sm:text-sm">
        ...
        <div className="mt-14 text-center sm:mt-16">
          <Link
            href="/#contact"
            className="inline-flex h-14 items-center justify-center border border-gold bg-transparent px-10 text-[12px] font-medium uppercase tracking-[0.08em] text-white transition-colors duration-300 hover:border-white hover:bg-white hover:text-[#050505]"
          >
