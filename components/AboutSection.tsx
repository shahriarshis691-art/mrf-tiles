...
export default function AboutSection() {
  return (
    <section
      ...
      className="bg-[#F5F1E8] px-4 py-12 sm:py-14 lg:py-14"
    >
      <div className="mx-auto grid min-h-[17rem] max-w-[1440px] grid-cols-1 md:grid-cols-2 items-stretch gap-4 md:gap-10 lg:gap-16 xl:gap-24">
        ...
        <ScrollReveal variant="slideInRight" delay={0.15} className="h-full">
          <div className="flex h-full flex-col py-3 md:block md:py-0">
            ...
            <h2
              id="about-heading"
              className="mt-2 font-sans text-2xl font-semib uppercase leading-tight tracking-[0.06em] text-[#0F0F0F] md:mt-5 md:text-[2.5rem] md:leading-[1.05] lg:text-[2.85rem]"
            >
              Crafting Spaces
              <br />
              With Purpose
            ...
            <span className="mt-3 block h-px w-10 bg-neutral-900 md:mt-5 md:w-12" />

            <p className="mt-4 line-clamp-3 max-w-lg text-xs leading-relaxed text-neutral-600 md:mt-7 md:line-clamp-none md:text-sm md:leading-relaxed">
            ...
            <p className="mt-3 line-clamp-3 max-w-lg text-xs leading-relaxed text-neutral-600 md:mt-5 md:line-clamp-none md:text-sm md:leading-relaxed">
            ...
            <dl className="mt-auto grid grid-cols-3 gap-2 border-t border-neutral-200 pt-4 text-center md:mt-12 md:gap-8 md:pt-10 md:text-left">
              {STATS.map((stat) => (
                <div key={stat.label}>
