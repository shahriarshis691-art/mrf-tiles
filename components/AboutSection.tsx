...
export default function AboutSection() {
  return (
    ...
    >
      <div className="mx-auto grid min-h-[17rem] max-w-[1440px] grid-cols-2 items-stretch gap-3 md:grid-cols-2 md:items-center md:gap-10 lg:gap-16 xl:gap-24">
        ...
        <ScrollReveal variant="slideInRight" delay={0.15} className="h-full">
          <div className="flex h-full flex-col py-3 md:block md:py-0">
            ...
            <h2
              id="about-heading"
              className="mt-2 font-sans text-[clamp(1.2rem,3.8vw,1.5rem)] font-semibold uppercase leading-[1.2] tracking-[0.06em] text-[#0F0F0F] md:mt-5 md:text-[2.5rem] md:leading-[1.05] lg:text-[2.85rem]"
            >
              Crafting Spaces
              <br />
              With Purpose
            ...
            <p className="mt-4 line-clamp-3 max-w-lg text-[11px] leading-[1.45] text-neutral-600 md:mt-7 md:line-clamp-none md:text-sm md:leading-relaxed">
            ...
            <p className="mt-3 line-clamp-3 max-w-lg text-[11px] leading-[1.45] text-neutral-600 md:mt-5 md:line-clamp-none md:text-sm md:leading-relaxed">
